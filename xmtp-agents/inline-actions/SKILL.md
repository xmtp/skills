...
- [xmtp-generalstore](https://github.com/xmtplabs/xmtp-agent-examples/tree/main/examples/xmtp-generalstore) - Full shopping cart with inline actions
- [xmtp-welcome-message](https://github.com/xmtplabs/xmtp-agent-examples/tree/main/examples/xmtp-welcome-message) - Welcome messages with buttons
