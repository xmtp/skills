...
- [xmtp-transactions](https://github.com/xmtplabs/xmtp-agent-examples/tree/main/examples/xmtp-transactions) - Full USDC transfer example
- [xmtp-smart-wallet](https://github.com/xmtplabs/xmtp-agent-examples/tree/main/examples/xmtp-smart-wallet) - Smart wallet integration
